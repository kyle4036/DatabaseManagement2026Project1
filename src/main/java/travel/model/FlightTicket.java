...
public class FlightTicket {
    ...
    public FlightTicket(int ticketNumber, String flightNumber, String lineID, int legOrder, LocalDate departureDate, String seatNumber, String ticketClass, String mealOrder){
